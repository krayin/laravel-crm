{{--
    Admin Layout Override (Upgrade-Safe)

    Este arquivo sobrescreve: packages/Webkul/Admin/src/Resources/views/components/layouts/index.blade.php
    Registrado via: Laravel view override (resources/views/vendor)

    Modificacoes:
    - Inclui partial theme-head.blade.php para injetar CSS vars do Brand Kit
    - Adiciona wrapper #brand-kit-scope para CSS custom escopado
--}}
<!DOCTYPE html>
...
<head>
    ...
    @php
        // Usa cor primaria do tema se disponivel
        $brandColor = isset($themeContext) && $themeContext->enabled
    ...
    {{-- Brand Kit: CSS Variables + Custom CSS --}}
    ...
    >
        ...
        >
            ...
            <div class="flex min-h-[calc(100vh-62px)] max-w-full flex-1 flex-col bg-gray-100 pt-3 transition-all duration-300 dark:bg-gray-950">
                <!-- Page Content Blade Component (com escopo para CSS custom) -->
                <div id="brand-kit-scope" class="px-4 pb-6 ltr:lg:pl-[85px] rtl:lg:pr-[85px]">
                    {{ $slot }}
                </div>
