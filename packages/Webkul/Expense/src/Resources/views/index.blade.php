<x-admin::layouts>
    <x-slot:title>
        @lang('expense::app.expenses.index.title')
    </x-slot>
    ...
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            <div class="flex flex-col gap-2">
                <div class="flex cursor-pointer items-center">
                    <!-- Breadcrumbs -->
                    <x-admin::breadcrumbs name="expense" />
                </div>
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                @if (bouncer()->hasPermission('expense.create'))
                    <div class="flex items-center gap-x-2.5">
                        <a
                            href="{{ route('admin.expense.create') }}"
                            class="primary-button"
                        >
                            @lang('expense::app.expenses.index.create-btn')
                        </a>
                    </div>
                @endif
        ...
        <x-admin::datagrid :src="route('admin.expense.index')">
            <!-- DataGrid Shimmer -->
