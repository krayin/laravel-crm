...
return [
    'seeders' => [
        'attributes' => [
            'leads' => [
                'description'         => 'توضیحات',
                'expected-close-date' => 'تاریخ پیش‌بینی بسته شدن',
        ...
        'email' => [
            ...
            'activity-modified'     => 'فعالیت اصلاح شد',
            'date'                  => 'تاریخ',
            'new-activity'          => 'شما یک فعالیت جدید دارید، لطفاً جزئیات را در زیر مشاهده کنید',
            'new-activity-modified' => 'یک فعالیت جدید اصلاح شده دارید، لطفاً جزئیات را در زیر مشاهده کنید',
        ...
        'workflow' => [
            'email-to-participants-after-activity-updation' => 'ایمیل به شرکت‌کنندگان پس از به‌روزرسانی فعالیت',
            'email-to-participants-after-activity-creation' => 'ایمیل به شرکت‌کنندگان پس از ایجاد فعالیت',
        ],
    ],
