...
return [
    'common' => [
        'auth' => [
            ...
            'token' => [
                'invalid' => 'رمز API المقدم غير صالح.',
                'missing' => 'رمز API مفقود من الطلب.',
            ],
        ],
    ...
    'token' => [
        ...
        'generate_error'   => 'حدث خطأ أثناء إنشاء الرمز.',
        'update_error'     => 'حدث خطأ أثناء تحديث الرمز.',
        'delete_error'     => 'حدث خطأ أثناء حذف الرمز.',
        'delete_success'   => 'تم حذف الرمز بنجاح.',
    ],
    'configuration' => [
