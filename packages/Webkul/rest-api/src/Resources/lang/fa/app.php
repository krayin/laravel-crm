...
return [
    'common' => [
        'auth' => [
            ...
            'token' => [
                'invalid' => 'توکن API ارائه‌شده نامعتبر است.',
                'missing' => 'توکن API در درخواست وجود ندارد.',
            ],
        ],
    ...
    'settings' => [
        ...
        'generate_error'   => 'خطا در تولید توکن.',
        'update_error'     => 'خطا در به‌روزرسانی توکن.',
        'delete_error'     => 'خطا در حذف توکن.',
        'delete_success'   => 'توکن با موفقیت حذف شد.',
    ],
        'configuration' => [
