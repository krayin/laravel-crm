    ...
    <div class="grid gap-y-8">
        @foreach (menu()->getAdminMenuByKey('settings')->getChildren() as $setting)
            <div>
                ...
                <div class="box-shadow max-1580:grid-cols-3 mt-2 grid grid-cols-4 flex-wrap justify-between gap-4 rounded bg-white p-4 dark:bg-gray-900 max-xl:grid-cols-2 max-sm:grid-cols-1 sm:gap-12 lg:gap-12">
                    <!-- Menus cards -->
