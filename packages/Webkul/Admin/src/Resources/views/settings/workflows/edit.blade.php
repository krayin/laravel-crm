            ...
            <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                <div class="flex flex-col gap-2">
                    <div class="flex cursor-pointer items-center">
                        {!! view_render_event('krayin.admin.settings.workflows.edit.breadcrumbs.before', ['workflow' => $workflow]) !!}
                        ...
                        {!! view_render_event('krayin.admin.settings.workflows.edit.breadcrumbs.after', ['workflow' => $workflow]) !!}
                    </div>
                ...
                <div class="flex items-center gap-x-2.5">
                    <div class="flex items-center gap-x-2.5">
                        {!! view_render_event('krayin.admin.settings.workflows.edit.save_button.before', ['workflow' => $workflow]) !!}
                        ...
                        {!! view_render_event('krayin.admin.settings.workflows.edit.save_button.after', ['workflow' => $workflow]) !!}
                    </div>
                </div>
            </div>
            ...
            <div class="flex gap-2.5 max-xl:flex-wrap">
                <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                    <div class="box-shadow rounded-lg border border-gray-200 bg-white p-4 dark:bg-gray-900">
                        {!! view_render_event('krayin.admin.settings.workflows.edit.form_controls.before') !!}
                        ...
                        <div class="flex flex-col gap-4">
                            {!! view_render_event('krayin.admin.settings.workflows.edit.basic_details.before', ['workflow' => $workflow]) !!}
                            ...
                            <div id="basic-details">
                                <div class="flex items-center justify-between gap-4 py-4">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-white">@lang('admin::app.settings.workflows.edit.basic-details-info')</p>
                                    </div>
                                </div>
                            ...
                            {!! view_render_event('krayin.admin.settings.workflows.edit.basic_details.after', ['workflow' => $workflow]) !!}

                            {!! view_render_event('krayin.admin.settings.workflows.edit.event.before', ['workflow' => $workflow]) !!}
                            ...
                            <div id="event">
                                <div class="flex items-center justify-between gap-4 py-4">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-white">@lang('admin::app.settings.workflows.edit.event-info')</p>
                                    </div>
                                </div>
                            ...
                            {!! view_render_event('krayin.admin.settings.workflows.edit.event.after', ['workflow' => $workflow]) !!}

                            {!! view_render_event('krayin.admin.settings.workflows.edit.condition.before', ['workflow' => $workflow]) !!}
                            ...
                            <div id="conditions">
                                <div class="flex items-center justify-between gap-4 py-4">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-white">@lang('admin::app.settings.workflows.edit.conditions-info')</p>
                                    </div>
                                </div>
                            ...
                            {!! view_render_event('krayin.admin.settings.workflows.edit.condition.after', ['workflow' => $workflow]) !!}

                            {!! view_render_event('krayin.admin.settings.workflows.edit.action.before', ['workflow' => $workflow]) !!}
                            ...
                            <div id="actions">
                                <div class="flex items-center justify-between gap-4 py-4">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <p class="text-sm text-gray-600 dark:text-white">@lang('admin::app.settings.workflows.edit.actions-info')</p>
                                    </div>
                                </div>
                            ...
                            {!! view_render_event('krayin.admin.settings.workflows.edit.action.after', ['workflow' => $workflow]) !!}
                        </div>

                        {!! view_render_event('krayin.admin.settings.workflows.edit.form_controls.after') !!}
                    </div>
                </div>
            </div>
        </script>
