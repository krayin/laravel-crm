...
@section('page_title')
    {{ __('admin::app.settings.workflows.add-title') }}
@stop
    ...
    <div class="content full-page adjacent-center">
        ...
        <div class="page-header">
            ...
            <div class="page-title">
                <h1>{{ __('admin::app.settings.workflows.add-title') }}</h1>
            </div>
        </div>
    ...
    <script type="text/x-template" id="workflow-component-template">
        ...
        <div>
            <div class="form-group" :class="[errors.has('name') ? 'has-error' : '']">
                ...
                <input type="text" name="name" class="control" v-validate="'required'" value="{{ old('name') }}" data-vv-as="{{ __('admin::app.settings.workflows.name') }}"/>
