...
@section('content-wrapper')
    <div class="content full-page adjacent-center">
        {!! view_render_event('admin.settings.groups.create.header.before') !!}
        ...
        {!! view_render_event('admin.settings.groups.create.header.after') !!}

        <form method="POST" action="{{ route('admin.settings.groups.store') }}" @submit.prevent="onSubmit">
