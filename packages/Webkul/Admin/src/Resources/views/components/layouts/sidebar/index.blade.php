<div
    ref="sidebar"
    class="duration-80 fixed top-[60px] z-[999] h-full w-[200px] border-gray-200 bg-white pt-4 transition-all group-[.sidebar-collapsed]/container:w-[70px] dark:border-gray-800 dark:bg-gray-900 ltr:border-r rtl:border-l"
