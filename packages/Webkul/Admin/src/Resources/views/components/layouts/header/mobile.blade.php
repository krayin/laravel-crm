<header class="sticky top-0 z-[10001] border-b border-gray-200 bg-white px-4 py-2.5 transition-all dark:border-gray-800 dark:bg-gray-900 lg:hidden">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <v-mobile-dark>
                    <div class="flex">
                        <span
                            class="icon-light cursor-pointer rounded-md p-1.5 text-2xl transition-all hover:bg-gray-100 dark:hover:bg-gray-950"
                        ></span>
                    </div>
                </v-mobile-dark>
...
<x-admin::drawer
    position="left"
    class="[&>div:nth-child(3)]:rounded-none [&>div:nth-child(3)]:m-0"
...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-mobile-dark', {
            template: '#v-mobile-dark-template',
