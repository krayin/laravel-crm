                                ...
                                <div class="rounded-lg bg-white p-2 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-950">
                                    <a href="{{ route('admin.quotes.create') }}">
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <span
                                                class="font-medium dark:text-gray-300">@lang('admin::app.layouts.quote')</span>
                                        </div>
                                    </a>
                                </div>
                            @endif
                                ...
                                <div class="rounded-lg bg-white p-2 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-950">
                                    <a href="{{ route('admin.mail.index', ['route' => 'inbox', 'openModal' => 'true']) }}">
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <span
                                                class="font-medium dark:text-gray-300">@lang('admin::app.layouts.email')</span>
                                        </div>
                                    </a>
                                </div>
                            @endif
                                ...
                                <div class="rounded-lg bg-white p-2 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-950">
                                    <a href="{{ route('admin.contacts.persons.create') }}">
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <span
                                                class="font-medium dark:text-gray-300">@lang('admin::app.layouts.person')</span>
                                        </div>
                                    </a>
                                </div>
                            @endif
                                ...
                                <div class="rounded-lg bg-white p-2 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-950">
                                    <a href="{{ route('admin.contacts.organizations.create') }}">
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <span
                                                class="font-medium dark:text-gray-300">@lang('admin::app.layouts.organization')</span>
                                        </div>
                                    </a>
                                </div>
                            @endif
                                ...
                                <div class="rounded-lg bg-white p-2 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-950">
                                    <a href="{{ route('admin.products.create') }}">
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <span
                                                class="font-medium dark:text-gray-300">@lang('admin::app.layouts.product')</span>
                                        </div>
                                    </a>
                                </div>
                            @endif
                                ...
                                <div class="rounded-lg bg-white p-2 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-950">
                                    <a href="{{ route('admin.settings.attributes.create') }}">
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <span
                                                class="font-medium dark:text-gray-300">@lang('admin::app.layouts.attribute')</span>
                                        </div>
                                    </a>
                                </div>
                            @endif
