...
<head>
    ...
    {{-- {{ 
        Vite::useHotFile('admin-vite.hot')
...
<body class="h-full dark:bg-gray-950">
    ...
    >
        ...
        >
            ...
            <div class="max-w-full flex-1 bg-white px-4 pb-6 pt- transition-all duration-300 dark:bg-gray-950 max-lg:!px-4 ltr:pl-[286px] group-[.sidebar-collapsed]/container:ltr:pl-[85px] rtl:pr-[286px] group-[.sidebar-collapsed]/container:rtl:pr-[85px]">
