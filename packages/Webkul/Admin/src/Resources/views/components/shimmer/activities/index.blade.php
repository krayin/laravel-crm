<div class="w-full rounded-md border border-gray-300 bg-white dark:border-gray-800 dark:bg-gray-900">
    <!-- Tabs -->
    <div class="flex gap-2 overflow-x-auto border-b border-gray-300 dark:border-gray-800">
        @for ($i = 0; $i < 5; $i++)
