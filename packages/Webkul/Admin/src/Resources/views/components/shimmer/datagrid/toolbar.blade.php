<div class="flex flex-col items-center justify-between gap-4 rounded-t-lg border border-b-0 border-gray-200 bg-white p-2 pl-2 pr-4 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 md:flex-row lg:flex-row">
    <!-- Left Toolbar -->
