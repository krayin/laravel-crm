...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <div
                    class="fixed z-[10002] mx-3 mt-3 rounded-t-lg bg-white dark:bg-gray-900 max-sm:!w-full"
                    :class="{
                    ...
                    v-if="isOpen"
                >
                    <div class="pointer-events-auto h-full w-full rounded-t-lg overflow-auto bg-white dark:bg-gray-900">
