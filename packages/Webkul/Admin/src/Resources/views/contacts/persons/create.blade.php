    ...
    <x-admin::form
        ...
        <div class="flex flex-col gap-4">
            ...
            <div
                ...
                <div class="tags-input-wrapper" data-type="mobile_numbers" data-index="${index}">
                    ...
                    <div class="flex space-x-1 items-center mt-1">
                        <input type="text" id="mobile_numbers_${index}" name="mobile_number_${index}" value="+971" class="tag-input input flex-grow" placeholder="Add phone" autocomplete="off" spellcheck="false" />
            ...
            `;
                                ...
                                // Sync date input
                                div.querySelector(`input[type="date"]`).addEventListener('input', function () {
                                    contacts[index].eid_expiry = this.value;
                                });

                                // Sync other inputs
                                div.querySelector(`input[name="related_contacts[${index}][name]"]`).addEventListener('input', e => {
                                    contacts[index].name = e.target.value;
                                });
                                div.querySelector(`select[name="related_contacts[${index}][type]"]`).addEventListener('change', e => {
