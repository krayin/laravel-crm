            ...
            <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                <div class="flex flex-col gap-2">
                    <div class="flex cursor-pointer items-center">
                        {!! view_render_event('krayin.admin.persons.create.breadcrumbs.before') !!}

                        <!-- Breadcrumb -->
                        <x-admin::breadcrumbs name="contacts.persons.create" />

                        {!! view_render_event('krayin.admin.persons.create.breadcrumbs.after') !!}
                    </div>
                ...
                <div class="flex items-center gap-x-2.5">
                    <div class="flex items-center gap-x-2.5">
                        {!! view_render_event('krayin.admin.persons.create.create_button.before') !!}
                        ...
                        {!! view_render_event('krayin.admin.persons.create.create_button.after') !!}
                    </div>
                </div>
            </div>
