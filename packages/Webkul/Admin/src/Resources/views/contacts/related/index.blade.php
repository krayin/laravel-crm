<x-admin::layouts>
    ...
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            <div class="flex flex-col gap-2">
                <x-admin::breadcrumbs name="contacts.relatedContact" />

                <div class="text-xl font-bold dark:text-white">
                    @lang('admin::app.contacts.relatedContact.index.title')
                </div>
            </div>

            <div class="flex items-center gap-x-2.5">
                <!-- Export Modal -->
                <x-admin::datagrid.export :src="route('admin.contacts.related-contacts.index')" />
                ...
                <div class="flex items-center gap-x-2.5">
                    ...
                    @if (bouncer()->hasPermission('contacts.relatedContact.create'))
                        <a
                            href="{{ route('admin.contacts.related-contacts.create') }}"
                            class="primary-button"
                        >
                            @lang('admin::app.contacts.relatedContact.index.create-btn')
                        </a>
                    @endif
    ...
    @pushOnce('scripts')
        ...
        >
            <x-admin::datagrid
                src="{{ route('admin.contacts.related-contacts.index') }}"
                :isMultiRow="true"
                ref="datagrid"
            >
                <template #header="{
                    ...
                    <template v-else>
                        <div class="row grid grid-cols-[.1fr_.2fr_.2fr_.2fr_.2fr_.2fr] grid-rows-1 items-center border-b px-4 py-2.5 dark:border-gray-800 max-lg:hidden">
                            <div
                                ...
                                v-for="(columnGroup, index) in [['id'], ['name'],['type'], ['emails'],['mobile_numbers']]"
                            >
                                <label
