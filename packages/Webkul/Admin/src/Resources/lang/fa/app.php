        ...
        'data-transfer' => [
            ...
            'imports' => [
                ...
                'import' => [
                    ...
                    'importing-queue-hint' => 'اگر این درون‌ریزی روی ۰٪ بماند، ممکن است کارگر صف در حال اجرا نباشد. از مدیر بخواهید \'php artisan queue:work\' را اجرا کند، یا \'پردازش در صف\' را خاموش کرده و دوباره درون‌ریزی کنید.',
                ...
                'queue-worker-not-running' => 'کارگر صف در حال اجرا نیست. برای پردازش این درون‌ریزی php artisan queue:work را اجرا کنید یا پردازش در صف را خاموش کرده و دوباره تلاش کنید.',
    ...
    'dashboard' => [
        'index' => [
            ...
            'pdf' => [
                ...
                'person' => 'شخص',
                'price' => 'قیمت',
                'revenue-by-sources' => 'درآمد بر اساس منابع',
                'revenue-by-types' => 'درآمد بر اساس انواع',
                'open-leads-by-stages' => 'سرنخ‌های باز بر اساس مراحل',
                'top-selling-products' => 'محصولات برتر',
                'top-persons' => 'افراد برتر',
            ],
            'revenue' => [
