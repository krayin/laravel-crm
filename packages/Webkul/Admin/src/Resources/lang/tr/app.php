...
return [
    ...
    'attributes' => [
        ...
        'description' => 'Açıklama',
        'name' => 'Ad',
        'lead_value' => 'Tahmini Lead Değeri',
        'lead_source_id' => 'Kaynak',
        'lead_type_id' => 'Tür',
        'user_id' => 'Satış Sahibi',
        'expected_close_date' => 'Beklenen Kapanış Tarihi',
        'lead_pipeline_id' => 'Pipeline',
        'lead_pipeline_stage_id' => 'Aşama',
        'emails' => 'E-postalar',
        'contact_numbers' => 'İletişim Numaraları',
        'job_title' => 'Görev Unvanı',
