...
return [
    ...
    'attributes' => [
        ...
        'description' => 'Descripción',
        'name' => 'Nombre',
        'lead_value' => 'Valor Estimado del Prospecto',
        'lead_source_id' => 'Fuente',
        'lead_type_id' => 'Tipo',
        'user_id' => 'Propietario de Ventas',
        'expected_close_date' => 'Fecha de Cierre Esperada',
        'lead_pipeline_id' => 'Pipeline',
        'lead_pipeline_stage_id' => 'Etapa',
        'emails' => 'Correos Electrónicos',
        ...
        'adjustment_amount' => 'Cantidad de Ajuste',
        'sub_total' => 'Subtotal',
        'grand_total' => 'Total General',
        'expired_at' => 'Expira el',
        'person_id' => 'Persona',
        'contact_name' => 'Nombre de Contacto',
        'contact_emails' => 'Correos Electrónicos de Contacto',
