...
return [
    ...
    'attributes' => [
        ...
        'description' => 'Mô tả',
        'name' => 'Tên',
        'lead_value' => 'Giá trị ước tính của khách hàng tiềm năng',
        'lead_source_id' => 'Nguồn',
        'lead_type_id' => 'Loại',
        'user_id' => 'Chủ sở hữu bán hàng',
        'expected_close_date' => 'Ngày dự kiến đóng',
        'lead_pipeline_id' => 'Kênh bán hàng',
        'lead_pipeline_stage_id' => 'Giai đoạn',
        'emails' => 'Email',
        'contact_numbers' => 'Số điện thoại liên hệ',
        'job_title' => 'Chức vụ',
