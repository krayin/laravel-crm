    ...
    'settings' => [
        ...
        'data-transfer' => [
            ...
            'imports' => [
                ...
                'queue-worker-not-running' => 'Queue worker không chạy. Hãy chạy php artisan queue:work để xử lý lần nhập này, hoặc tắt Xử lý trong hàng đợi và thử lại.',
    ...
    'dashboard' => [
        'index' => [
            ...
            'pdf' => [
                ...
                'price' => 'Giá',
                'revenue-by-sources' => 'Doanh Thu Theo Nguồn',
                'revenue-by-types' => 'Doanh Thu Theo Loại',
                'open-leads-by-stages' => 'Khách hàng tiềm năng mở theo giai đoạn',
                'top-selling-products' => 'Sản Phẩm Bán Chạy Nhất',
                'top-persons' => 'Người Liên Hệ Hàng Đầu',
            ],
            'revenue' => [
