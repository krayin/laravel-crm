        ...
        'marketing' => [
            'events' => [
                'index' => [
                    ...
                    'delete-failed-associated-campaigns' => 'Không thể xóa sự kiện vì nó liên kết với các chiến dịch hiện có. Vui lòng tách hoặc cập nhật các chiến dịch đó trước khi xóa.',
                    'datagrid'            => [
                        'delete'      => 'Xóa',
                        'edit'        => 'Chỉnh sửa',
                        'id'          => 'ID',
