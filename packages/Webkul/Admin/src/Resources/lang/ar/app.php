...
return [
    ...
    'attributes' => [
        ...
        'description' => 'الوصف',
        'name' => 'الاسم',
        'lead_value' => 'القيمة التقديرية للعميل المحتمل',
        'lead_source_id' => 'المصدر',
        'lead_type_id' => 'النوع',
        'user_id' => 'مالك المبيعات',
        'expected_close_date' => 'تاريخ الإغلاق المتوقع',
        'lead_pipeline_id' => 'قناة المبيعات',
        'lead_pipeline_stage_id' => 'المرحلة',
        'emails' => 'البريد الإلكتروني',
        ...
        'sub_total' => 'المبلغ الإجمالي الفرعي',
        'grand_total' => 'المبلغ الإجمالي',
        'expired_at' => 'منتهي في',
        'person_id' => 'شخص',
        'contact_name' => 'اسم جهة الاتصال',
        'contact_emails' => 'البريد الإلكتروني لجهة الاتصال',
