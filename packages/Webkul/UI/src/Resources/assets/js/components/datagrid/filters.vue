                            ...
                            <li>
                                <div class="control-group">
                                    <select
                                        ...
                                        :click="getColumnOrAlias(filterColumn)"
                                    >
                            ...
                            <li v-if='stringConditionSelect'>
                                <div class="control-group">
                                    <select class="control" v-model="stringCondition">
                                        <option selected disabled>
                                            {{ __('ui.datagrid.condition') }}
                                        </option>

                                        <option value="like">
                                            {{ __('ui.datagrid.contains') }}
                                        </option>

                                        <option value="nlike">
                                            {{ __('ui.datagrid.ncontains') }}
                                        </option>

                                        <option value="eq">
                                            {{ __('ui.datagrid.equals') }}
                                        </option>

                                        <option value="neqs">
                                            {{ __('ui.datagrid.nequals') }}
                                        </option>
                            ...
                            <li v-if='stringCondition != null'>
                                <div class="control-group">
                                    <input
                                        ...
                                        :placeholder="__('ui.datagrid.value-here')"
                                    />
                                </div>
                            </li>
                            ...
                            <li v-if='numberCondition != null'>
                                <div class="control-group">
                                    <input
                                        ...
                                        :placeholder="__('ui.datagrid.numeric-value-here')"
                                    />
                                </div>
                            </li>
