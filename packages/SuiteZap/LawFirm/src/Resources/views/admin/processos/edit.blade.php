<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.processos.update', $processo->id)" method="PUT" enctype="multipart/form-data">
        <div class="flex flex-col gap-4">
            ...
            @include('lawfirm::admin.processos.partials.anexos', ['editable' => true, 'anexos' => $processo->anexos])
                ...
                <div class="flex w-1/2 flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            type="text"
                            name="juiz_atual"
                             :value="old('juiz_atual', $processo->juiz_atual)"
                            label="Juiz(a) Atual"
                    ...
                    <x-admin::form.control-group>
                        ...
                        >
                            ...
                            @foreach(['Inicial', 'Contestação', 'Réplica', 'Instrução', 'Julgamento', 'Sentença', 'Recurso', 'Execução'] as $phase)
                                <option value="{{ $phase }}" {{ old('fase_processual', $processo->fase_processual) == $phase ? 'selected' : '' }}>
                                    {{ $phase }}
                                </option>
                            @endforeach
                        </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group class="w-1/2">
                            ...
                            >
                                ...
                                @foreach(['Civil', 'Trabalhista', 'Penal', 'Tributário', 'Família', 'Consumidor', 'Previdenciário'] as $area)
                                    <option value="{{ $area }}" {{ old('area_direito', $processo->area_direito) == $area ? 'selected' : '' }}>
                                        {{ $area }}
                                    </option>
                                @endforeach
                            </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group class="w-1/2">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="subarea_direito"
                                 :value="old('subarea_direito', $processo->subarea_direito)"
                ...
                <x-admin::form.control-group>
                    ...
                    >
                        <option value="">@lang('lawfirm::app.processos.form.select-choose')</option>
                            ...
                            <option value="{{ $prob }}" {{ old('probabilidade_exito', $processo->probabilidade_exito) == $prob ? 'selected' : '' }}>
                                {{ $prob }}
                            </option>
                        @endforeach
                    </x-admin::form.control-group.control>
                ...
                <div class="flex w-1/2 flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            value="{{ old('tipo_parte', $processo->tipo_parte) }}"
                        >
                             <option value="autor" {{ old('tipo_parte', $processo->tipo_parte) == 'autor' ? 'selected' : '' }}>Autor</option>
                             <option value="reu" {{ old('tipo_parte', $processo->tipo_parte) == 'reu' ? 'selected' : '' }}>Réu</option>
                        </x-admin::form.control-group.control>
                        ...
                        <x-admin::form.control-group class="w-1/2">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="advogado_responsavel_nome"
                                 :value="old('advogado_responsavel_nome', $processo->advogado_responsavel_nome)"
                        ...
                        <x-admin::form.control-group class="w-1/2">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="advogado_responsavel_oab"
                                 :value="old('advogado_responsavel_oab', $processo->advogado_responsavel_oab)"
                                label="OAB"
                ...
                <div class="flex w-1/2 flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <!-- NEW: Tipo de Pessoa -->
                         <x-admin::form.control-group class="w-1/3">
                            ...
                            <x-admin::form.control-group.control
                                ...
                                label="Tipo"
                                onchange="toggleMask()"
                                value="{{ old('opposing_party_type', $processo->opposing_party_type) }}"
                            >
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            type="text"
                            name="advogado_oab"
                             :value="old('advogado_oab', $processo->advogado_oab)"
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            name="whatsapp_advogado_contrario"
                             :value="old('whatsapp_advogado_contrario', $processo->whatsapp_advogado_contrario)"
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            name="email_advogado_contrario"
                             :value="old('email_advogado_contrario', $processo->email_advogado_contrario)"
                ...
                <div class="flex w-1/2 flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            type="text"
                            name="link_audiencia"
                             :value="old('link_audiencia', $processo->link_audiencia)"
